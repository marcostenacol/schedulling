...
class CreateServiceServiceTest {
  ...
  @InjectMocks private CreateServiceService createServiceService;
  ...
  void shouldCreateServiceSuccessfully() {
    ...
    ServiceResponseDTO response =
        createServiceService.execute(new CreateServiceRequest(provider, createDTO));
