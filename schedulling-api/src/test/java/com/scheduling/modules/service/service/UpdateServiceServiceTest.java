...
class UpdateServiceServiceTest {
    ...
    void shouldUpdateServiceSuccessfully() {
        ...
        ServiceResponseDTO response = updateServiceService.execute(new UpdateServiceRequest(serviceId, provider, dto));
    ...
    void shouldThrowExceptionWhenForbidden() {
        ...
        AppException exception = assertThrows(AppException.class, () -> 
            updateServiceService.execute(new UpdateServiceRequest(serviceId, anotherProvider, dto)));
