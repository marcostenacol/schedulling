...
/**
 * Testes de validação de entrada do AuthController#login.
 * Cobre o gap de teste de integração/Controller apontado como débito técnico
 * (só havia testes unitários de Service antes).
 * Filtros de segurança desabilitados (addFilters = false) para isolar a validação
 * de @Valid/Bean Validation do fluxo de autenticação em si.
 */
