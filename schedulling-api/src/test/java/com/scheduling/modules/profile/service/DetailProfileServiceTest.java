...
class DetailProfileServiceTest {
  ...
  @InjectMocks private DetailProfileService detailProfileService;
  ...
  void setUp() {
    ...
    profile =
        Profile.builder().id(UUID.randomUUID()).user(user).name("Test User").type("client").build();
  }
  ...
  void shouldThrowExceptionWhenProfileNotFound() {
    ...
    AppException exception =
        assertThrows(AppException.class, () -> detailProfileService.execute(userId));
