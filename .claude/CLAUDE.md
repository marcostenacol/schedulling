...
**Nota**: o item "Sem Flyway/Liquibase" listado acima **não foi tratado por esta rodada** — está sendo conduzido separadamente e diretamente contra o banco em produção pelo operador humano; a linha correspondente na tabela de débito técnico permanece como estava, intencionalmente não marcada como resolvida.
